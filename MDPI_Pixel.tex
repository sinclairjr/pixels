...
LArTPCs are intrinsically slow detectors with a drift speed of \SI{2.1}{\milli\metre\per\micro\second} at \SI{1}{\kilo\volt\per\centi\metre}~\cite{protoLASER}, therefore LArTPCs with drift lengths of $\mathcal{O}\left(1\right)\,\SI{}{\metre}$ have readout windows of $\mathcal{O}\left(100\right)\,\SI{}{\micro\second}$. 
LArTPCs deployed in neutrino beams with spills of $\mathcal{O}\left(10\right)\,\SI{}{\micro\second}$~\cite{numi, DUNE3} long will have multiple events pile-up in the same readout window, this is problematic for projective wire readouts.
