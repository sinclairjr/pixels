...
As mentioned, the multiplexing scheme divides the pixel plane into a number of ROIs, each ROI is defined as the pixels contained within a single section of inductive focusing grid. 
The following is taken from~\cite{maplesyrup}.
